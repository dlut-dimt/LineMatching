...
for i=1:n
    ...
    for j=1:n
        ...
        for k=j+1:n
            ...
            CN1=charanums5(line1.intsect1(1), line1.intsect1(2), line1.intsect2(1),line1.intsect2(2), ps1(i,1), ps1(i,2),ps1(j,1),ps1(j,2), ps1(k,1),ps1(k,2));
            CN2=charanums5(line2.intsect1(1), line2.intsect1(2), line2.intsect2(1),line2.intsect2(2), ps2(i,1), ps2(i,2),ps2(j,1),ps2(j,2), ps2(k,1),ps2(k,2));
